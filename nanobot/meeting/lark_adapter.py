...
from nanobot.meeting.lark_oapi_provider import OapiLarkProvider, OapiRequest, WRITE_OP_NAMES
...
class LarkToolAdapter:
    ...
    def redact(self, value: str) -> str:
        ...
        redacted = re.sub(
            r'(?i)"(app_secret|access_token|refresh_token|authorization|cookie|password|passcode|meeting_password)"\s*:\s*"[^"]*"',
            r'"\1": "[REDACTED]"',
            redacted,
        )
