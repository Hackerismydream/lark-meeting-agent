# Ux Spec Delta for Phase 1: macOS Product Contract and Agent API Contract

## ADDED Requirements

### Requirement: Phase 1: macOS Product Contract and Agent API Contract Ux Contract

The system MUST satisfy the ux contract for this V1.1 phase.
