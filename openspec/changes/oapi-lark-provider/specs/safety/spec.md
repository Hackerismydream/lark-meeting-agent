# Delta for Safety in Production Lark OpenAPI Provider

## ADDED Requirements

### Requirement: Safety Boundary for oapi-lark-provider

The system MUST preserve existing enterprise collaboration safety constraints during `oapi-lark-provider`.
